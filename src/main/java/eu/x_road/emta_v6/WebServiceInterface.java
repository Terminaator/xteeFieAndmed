...
public interface WebServiceInterface {
    ...
    public void xteeFieAndmed(
        @WebParam(mode = WebParam.Mode.INOUT, name = "keha", targetNamespace = "")
        javax.xml.ws.Holder<PersonalIdentityCode> keha,
        ...
        javax.xml.ws.Holder<XteeFieAndmedResponseType> paring
    );
}
